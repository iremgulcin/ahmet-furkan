...
class MainWindow(QtWidgets.QMainWindow, QtWidgets.QApplication):
    ...
    def add_brain_settings_widget(self):
        brain_group_box = QtWidgets.QGroupBox("Beyin Ayarları")
        brain_group_layout = QtWidgets.QGridLayout()
        brain_group_layout.addWidget(QtWidgets.QLabel("Beyin Eşik Değeri"), 0, 0)
        brain_group_layout.addWidget(QtWidgets.QLabel("Beyin Opaklığı"), 1, 0)
        brain_group_layout.addWidget(QtWidgets.QLabel("Beyin Kenar Yumuşatma"), 2, 0)
        brain_group_layout.addWidget(QtWidgets.QLabel("Görüntü Yoğunluğu"), 3, 0)
        ...
        brain_group_layout.addWidget(QtWidgets.QLabel("Axial Kesit"), 6, 0)
        brain_group_layout.addWidget(QtWidgets.QLabel("Coronal Kesit"), 7, 0)
        brain_group_layout.addWidget(QtWidgets.QLabel("Sagittal Kesit"), 8, 0)
    ...
    def add_mask_settings_widget(self):
        mask_settings_group_box = QtWidgets.QGroupBox("Maske Ayarları")
        mask_settings_layout = QtWidgets.QGridLayout()
        mask_settings_layout.addWidget(QtWidgets.QLabel("Maske Opaklığı"), 0, 0)
        mask_settings_layout.addWidget(QtWidgets.QLabel("Maske Pürüzsüzlüğü"), 1, 0)
        mask_settings_layout.addWidget(self.mask_opacity_sp, 0, 1)
        mask_settings_layout.addWidget(self.mask_smoothness_sp, 1, 1)
        mask_multi_color_radio = QtWidgets.QRadioButton("Çoklu Renk")
        mask_multi_color_radio.setChecked(True)
        mask_multi_color_radio.clicked.connect(self.mask_multi_color_radio_checked)
        mask_single_color_radio = QtWidgets.QRadioButton("Tek Renk")
    ...
    def add_views_widget(self):
        ...
        views_box = QtWidgets.QGroupBox("Görüntüleme")
    ...
    def add_brain_projection(self):
        projection_cb = QtWidgets.QCheckBox("Projeksiyon")
